...
export const translations = {
  en: {
    ...
    login: {
      ...
      welcomeMessage: 'New to website? Register with your personal details',
      signUpText: 'SIGN UP',
    },
    home: {
      ...
      'SATELLITE DATA ANALYTICS': 'SATELLITE DATA ANALYTICS',
    },
    about: {
    ...
    services: {
      ...
      prediction: {
        ...
        description: 'Advanced AI-powered crop yield forecasting',
      },
      monitoring: {
        title: 'Crop Monitoring',
        description: 'Real-time satellite-based crop health tracking',
      },
      analytics: {
    ...
    cropRecommendation: {
      ...
      successMessage: "Maize is the best crop for your conditions!",
      failureMessage: "Failed to get crop recommendation",
    },
    profile: {
    ...
    settings: {
      ...
      marketPrices: 'Market Prices Updates',
      language: 'Language',
  ...
  hi: {
    ...
    home: {
      ...
      'SUSTAINABILITY INSIGHTS': 'सततता के विचार',
      'PRECISION FARMING': 'सटीक कृषि',
      'SATELLITE DATA ANALYTICS': 'सैटेलाइट डेटा विश्लेषण',
    },
    signup: {
      title: 'खाता बनाएँ',
    ...
    callToAction: {
      heading: 'तुम्हें किस बात का इंतजार है?',
      cropYieldPrediction: 'फसल उत्पादन भविष्यवाणी',
      cropHealthMonitoring: 'फसल स्वास्थ्य निगरानी',
      sustainabilityInsights: 'सततता संबंधी अंतर्दृष्टियाँ',
      learnMore: 'और जानें',
    },
    features: {
    ...
    services: {
      ...
      prediction: {
        ...
        description: 'उन्नत एआई-संचालित फसल उपज पूर्वानुमान',
      },
      monitoring: {
        title: 'फसल निगरानी',
        description: 'रीयल-टाइम उपग्रह-आधारित फसल स्वास्थ्य ट्रैकिंग',
      },
      analytics: {
        title: 'डेटा विश्लेषण',
        description: 'व्यापक कृषि डेटा विश्लेषण',
      },
    },
    contact: {
      title: 'संपर्क करें',
    ...
    cropRecommendation: {
      ...
      humidity: "नमीयता (%)",
      rainfall: "वृष्टि (मिमी)",
      submitButton: "डाटा सबमिट करें",
