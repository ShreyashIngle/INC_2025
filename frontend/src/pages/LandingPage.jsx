...
function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#DFF2EB] via-[#B9E5E8] to-[#7AB2D3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="inline-block bg-[#4A628A]/10 rounded-full px-4 py-2 mb-6">
              <span className="text-[#4A628A] font-medium">Your Learning Journey Starts Here</span>
            </div>
            
            <h1 className="text-4xl lg:text-6xl font-bold text-[#4A628A] mb-6 leading-tight">
              Master Your<br />
              Tech Career<br />
            ...
            <div className="flex gap-4">
              ...
              <button className="inline-flex items-center px-6 py-3 text-[#4A628A] hover:bg-[#4A628A]/10 rounded-full font-semibold transition-colors">
